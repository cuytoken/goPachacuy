    ...
    IERC777Recipient
{
 ...
 function getAuthorizedPCUY( address player) public view returns (uint256) {
    ...
    function swapUSDC_To_PCUY(uint256 _usdcAmount) public whenNotPaused {
        ...
        uint256 tokenToTransfer = Math.mulDiv(_usdcAmount, _swapPercentageUSDCtoPcuy, 100 * 1e18);
    ...
    function swapPCUY_To_USDC(uint256 _pcuyAmount) public whenNotPaused {
        ...
        require(pcuyAutorized>=_pcuyAmount,"Pachacuy SWAP:Unauthorized amount of tokens");
        ...
        uint256 tokenToTransfer = Math.mulDiv(_pcuyAmount, _swapPercentagePCUYtoUSDC, 100 * 1e18);
